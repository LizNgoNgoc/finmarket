...
export default function PayAttentionBorrow() {
    ...
    <div className={styles.container_info}>
        ...
        <div className={styles.text_container}>
            <li className={styles.text_attention}>Перед подписанием договора обязательно полностью его прочитайте и если что-то непонятно, 
                то уточните информацию у заимодавца или возьмите с собой квалифицированного Юриста/Адвоката которого вы сможете найти на 
                UFEx.pro;</li>
            ...
            <li className={styles.text_attention}>Старайтесь соблюдать все условия, прописанные в договоре и 
                возвращать займ в установленные сроки.</li>
        </div>
    </div>
        <div className={styles.text_special}>
                <p className={styles.text_attention}>У нас на сайте собраны надежные кредиторы, которые готовы предложить вам денежные средства на самых выгодных  условиях. Как показаламировая практика, такой способ получения займов является наиболееудобным и выгодным, так как 
